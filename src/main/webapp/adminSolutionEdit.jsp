...
<div class="pure-g">
    ...
    <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-4-6"><p>
        <h2>Ocena rozwiązania i dodawanie komantarza</h2>
        <c:if test="${msg!=null}"><p style="color :red;text-align: center">${msg}</p></c:if>
        <form class="pure-form pure-form-aligned" action="${pageContext.request.contextPath}/app/admin/adminSolutionEdit" method="post">
            ...
            <fieldset>
                ...
                <div class="pure-control-group">
                    ...
                    <textarea readonly id="description" style="height: 200px" class="pure-input-3-4" placeholder="User solution" name="solutionDescription">${solution.description}</textarea>
                </div>

                <div class="pure-control-group">
                    <label for="rating">Ocena</label>
                    <input id="rating" type="text" placeholder="rating" name="solutionRating" value="${solution.rating}">
                    <button type="submit" class="pure-button pure-button-primary">Zapisz ocenę</button>
                </div>
            </fieldset>
        </form>
