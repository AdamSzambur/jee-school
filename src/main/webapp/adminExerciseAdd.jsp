...
<div class="pure-g">
    ...
    <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-4-6"><p>
        ...
        <form class="pure-form pure-form-aligned" action="${pageContext.request.contextPath}/app/admin/adminExerciseAdd" method="post">
            ...
            <button type="submit" class="pure-button pure-input-1 pure-button-primary">Dodaj zadanie</button>
        </form>
    </div>
    <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-1-6"><p></p></div>
</div>
